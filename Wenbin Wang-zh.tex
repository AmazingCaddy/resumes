...
\begin{body}
	...
	%\smallskip
	{\fontarial UCM(Unified Customer Management)} \hfill {\fontarial 2015/07 - NOW}\\ 
	%\smallskip
	{\fontarial UCM}是{\fontarial Bing Ads}的统一用户管理工具，主要供广告销售团队使用，以此来服务广告主。{\fontarial UCM}是一个{\fontarial Web}产品，整个产品的架构：{\fontarial 1)} 前端是一个{\fontarial SPA}，使用{\fontarial TypeScript}开发，通过{\fontarial Ajax}调用从后端获取数据；{\fontarial 2)} 后端是一个{\fontarial ASP.Net MVC}服务，会从{\fontarial UCM}的数据库和第三方服务获取数据，进行计算，返回给前端；{\fontarial 3)} {\fontarial Azure Data Factory}同步数据到{\fontarial UCM}的数据库。\\
	%\smallskip
	本人的主要工作内容：\\ 
	%\smallskip
	\vspace*{-6pt}
...
\begin{body}
	...
	%\smallskip
	广告管家 \hfill {\fontarial 2013/07 - 2013/10}\\ 
	%\smallskip
	...
	%\smallskip
	益暖中华{\fontarial (G1C1)} \hfill {\fontarial 2012/02 - 2012/08}\\ 
	%\smallskip
...
\begin{body}
	...
	做事专注，喜欢钻研，相信技术改变世界。\\
	乐观开朗，热爱生活，一个发散正能量的人。\\
%	具有{\fontarial Web}前端开发基础和经验 涉及过后端的开发\\
%	较好的掌握了算法和数据结构\\
%	编程语言：{\fontarial TypeScript/JavaScript/ES6} {\fontarial C/C\raise.3ex\hbox{\small++}} {\fontarial Python} {\fontarial Java}\\
