...
\begin{body}
	\vspace{14pt}
	\textbf{苏州美能华智能科技} \hfill 研发总监 {\fontarial 2019/04 - }\\
	\smallskip
	\begin{justify}
...
% 	\vspace*{-10pt}
% 	\begin{itemize} \itemsep -0pt  % reduce space between items
% 		\item 智能客服系统：我负责对接客户的定制化需求，完成了大部分前后端开发工作。\\
% 	\end{itemize}
% 	\vspace*{-10pt}
% 	\begin{itemize} \itemsep -0pt  % reduce space between items
% 		\item 参与设计了星原AI+RPA低代码平台，带领团队开发了平台的6大组成服务。\\
% 	\end{itemize}
% 	\vspace*{-10pt}
% 	\begin{itemize} \itemsep -0pt  % reduce space between items
% 		\item 根据小星助手（\url{https://xiaoxing.meinenghua.com}）的需求，参与产品功能设计，完成系统设计和前后端开发。\\
% 	\end{itemize}
% %	\vspace*{-10pt}
% %	\begin{itemize} \itemsep -0pt  % reduce space between items
